package com.jotime.system.service.impl;

import com.jotime.common.annotation.DataScope;
...
import com.jotime.common.utils.bean.BeanValidators;
import com.jotime.common.utils.spring.SpringUtils;
import com.jotime.system.domain.SysPost;
import com.jotime.system.domain.SysUserPost;
import com.jotime.system.domain.SysUserRole;
import com.jotime.system.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService
{
     ...
     */
    @Override
    public String checkEeCodeUnique(SysUser user)
    {
        Long userId = StringUtils.isNull(user.getUserId()) ? -1L : user.getUserId();
        SysUser info = userMapper.checkEeCodeUnique(user.getEeCode());
        if (StringUtils.isNotNull(info) && info.getUserId().longValue() != userId.longValue())
        {
            return UserConstants.NOT_UNIQUE;
        }
