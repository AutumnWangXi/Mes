...
<div align="center">
    ...
    <div style="page-break-after: always;">
        ...
        <br/>
        <div style="float:left">产品名称：${(item.itemName)!''}</div>
        <table  width="100%">
            ...
            <tr style="height: 20px">
                <td style="height: 10px" colspan="1" class="right" valign="middle"> 称重人：</td>
                <td style="height: 10px" colspan="1" class="right" valign="middle"> 重量：</td>
            </tr>
            <tr style="height: 20px">
                <td colspan="2" class="right"> 称重时间：</td>
            </tr>
            <tr style="height: 20px">
                <td colspan="2" class="right"> 件数编号：${(item.number)!''}</td>
            </tr>
        </table>
        <div style="float:left"><span>生产任务编号:${(item.originOrderNo)!''}</span></div>
        <br/>
        <div style="float:left"><span>生产通知单编号:${(item.stockinNoticeNo)!''}</span></div>
        <br/>
        </#list>
        </#if>
</body>
