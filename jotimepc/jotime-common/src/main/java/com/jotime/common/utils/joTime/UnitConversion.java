...
public class UnitConversion {
    ...
    public enum UnitsEnum {
         ...
         * 体积计量单位
         */
        TJ_L(CategoryEnum.VOLUME, "l", new String[]{"l", "升"}, new BigDecimal("0.001"), "升"),
        TJ_DL(CategoryEnum.VOLUME, "dl", new String[]{"dl", "分升"}, new BigDecimal("0.01"), "分升"),
        TJ_CL(CategoryEnum.VOLUME, "cl", new String[]{"cl", "厘升"}, new BigDecimal("0.1"), "厘升"),
        TJ_ML(CategoryEnum.VOLUME, "ml", new String[]{"ml", "毫升"}, new BigDecimal("1"), "毫升"),
        ...
        private enum CategoryEnum {
             ...
             * 容积
             */
            VOLUME("Volume", UnitsEnum.TJ_ML, "容积"),
            /**
             * 质量
             */
