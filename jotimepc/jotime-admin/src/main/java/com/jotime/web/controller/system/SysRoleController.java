...
import com.jotime.framework.web.service.SysPermissionService;
import com.jotime.framework.web.service.TokenService;
...
public class SysRoleController extends BaseController
{
     ...
     * @return 员工列表
     */
    @GetMapping("/getInforoleList")
    public AjaxResult getInforoleList() {
        AjaxResult ajax = AjaxResult.success();
        return ajax.put("inforoleList", roleService.selectRoleAll());
    }
