 ...
 * @date 2021-12-27
 */
public class BaseCustomersVo extends BaseEntity
{
    ...
    /** 包材合作供应商,0:不是，1:是 */
    @Excel(name = "包材合作供应商,0:不是，1:是")
    private Integer packagingSupplier;

    /** 成品合作供应商，0 不是  1 是 */
    @Excel(name = "成品合作供应商，0 不是  1 是")
    ...
    /** 1 国内客户  2 国外客户  9 不清楚 */
    @Excel(name = "1 国内客户  2 国外客户  9 不清楚")
    private Integer customerType;

    /** 1 新客户  2 重点老客户  3  非重点老客户 */
    @Excel(name = "1 新客户  2 重点老客户   3 非重点老客户")
