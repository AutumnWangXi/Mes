...
public class BaseDeviceVos extends BaseEntity
{
    ...
    public String getDeviceLeaderName() {
        return deviceLeaderName;
    }

    public void setDeviceLeaderName(String deviceLeaderName) {
        this.deviceLeaderName = deviceLeaderName;
    }
