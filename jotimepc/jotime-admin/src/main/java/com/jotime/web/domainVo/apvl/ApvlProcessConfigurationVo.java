 ...
 * @date 2021-12-26
 */
public class ApvlProcessConfigurationVo extends BaseEntity
{
    ...
    public void setIsProposer(Integer isProposer)
    {
        this.isProposer = isProposer;
    }

    public Integer getIsProposer()
    {
        return isProposer;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("note", getNote())
            .append("isProposer", getIsProposer())
