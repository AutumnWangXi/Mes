package com.jotime.web.controller.system;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        ...
        else if (StringUtils.isNotEmpty(user.getEeCode())
                && UserConstants.UNIQUE.equals(employeeInfoService.checkEeCodeUnique(user.getEeCode())))
        {
            return AjaxResult.error("新增用户'" + user.getUserName() + "'失败，员工编码不正确");
        }
        else if (StringUtils.isNotEmpty(user.getEeCode())
                && UserConstants.NOT_UNIQUE.equals(userService.checkEeCodeUnique(user)))
        {
            return AjaxResult.error("新增用户'" + user.getUserName() + "'失败，员工编码已存在");
        }
    ...
    public AjaxResult edit(@Validated @RequestBody SysUser user)
    {
        ...
        if (StringUtils.isNotEmpty(user.getEeCode())
            && UserConstants.UNIQUE.equals(employeeInfoService.checkEeCodeUnique(user.getEeCode())))
        {
            return AjaxResult.error("新增用户'" + user.getUserName() + "'失败，员工编码不正确");
        }
