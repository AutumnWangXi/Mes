  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="85px">
      ...
      <el-form-item label="生产商" prop="mfrsId">
        <el-select v-model="queryParams.mfrsId" filterable placeholder="请选择" size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="brandList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生产商" align="center" prop="mfrsName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="55%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="生产商" prop="mfrsId">
          <el-select v-model="form.mfrsId" filterable placeholder="请选择" size="small">
            <el-option
              v-for="item in mfrsOptions"
              :key="item.id"
              :label="item.mfrsName"
...
<script>
import {listBrand, getBrand, delBrand, addBrand, updateBrand, getMfrsInfo} from "@/api/jotime/base/basics/brand";
...
export default {
  ...
  methods: {
    ...
    /** 查询品牌列表 */
    getMfrsOptions(sts) {
      getMfrsInfo(sts).then(response => {
        this.mfrsOptions = response.data;
      });
    },
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('web/brand/export', {
        ...this.queryParams
