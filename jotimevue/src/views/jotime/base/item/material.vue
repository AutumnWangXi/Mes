<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="原料名称" prop="itemName">
        <el-input
...
<!--          </el-col>-->
          <el-col :span="12">
            <el-form-item label="原料属性" prop="property">
              <el-input v-model="form.property" placeholder="请输入原产地"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  dicts: ['sys_brand_own', 'sys_yes_no', 'sys_jotime_data_status', 'sys_sales_type', 'sys_product_type', 'sys_material_property', 'sys_material_category','base_item_own'],
  data() {
    return {
      UUID: null,
      inciNameEnlist: [],
