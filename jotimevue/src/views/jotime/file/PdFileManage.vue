...
<script>
import { listManage, getManage, delManage, addManage, updateManage } from "@/api/jotime/file/PdFileManage";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除描述 生产文件管理编号为"' + ids + '"的数据项？').then(function() {
