  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="流程描述" prop="moduleDescribe">
        <el-input
          v-model="queryParams.moduleDescribe"
          placeholder="请输入流程描述"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="moduleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="流程编号" align="center" prop="moduleNo" />
      <el-table-column label="流程名称" align="center" prop="moduleName" />
      <el-table-column label="流程描述" align="center" prop="moduleDescribe" />
...
<script>
import {listModule, getModule, delModule, addModule, updateModule, moduleDataList} from "@/api/jotime/pd/module";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除描述：生产流程名称编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('web/module/export', {
        ...this.queryParams
